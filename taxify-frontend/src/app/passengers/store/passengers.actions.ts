...
export const LOAD_SELECTED_ROUTE_DETAILS = '[Passenger] Load selected route details';
export const SET_SELECTED_ROUTE_DETAILS = '[Passenger] Set selected route details';
